...
```sh
$ docker build -t dtcxiang/flask-kubernetes ./services/server
$ docker push dtcxiang/flask-kubernetes
```

> Make sure to replace `dtcxiang` with your Docker Hub namespace in the above commands as well as in *kubernetes/flask-deployment.yml*
...
```sh
$ docker build -t dtcxiang/vue-kubernetes ./services/client \
    -f ./services/client/Dockerfile-minikube

$ docker push dtcxiang/vue-kubernetes
```

> Again, replace `dtcxiang` with your Docker Hub namespace in the above commands as well as in *kubernetes/vue-deployment.yml*
